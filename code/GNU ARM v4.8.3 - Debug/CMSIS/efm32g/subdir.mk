...
CMSIS/efm32g/%.o: ../CMSIS/efm32g/%.s
	...
	arm-none-eabi-gcc -g -gdwarf-2 -mcpu=cortex-m3 -mthumb -c -x assembler-with-cpp -I"F:/github/USB-voltmeter/code/inc" -I"H:/SimplicityStudio/v3/developer/sdks/efm32/v2/CMSIS/Include" -I"H:/SimplicityStudio/v3/developer/sdks/efm32/v2/emlib/inc" -I"H:/SimplicityStudio/v3/developer/sdks/efm32/v2/kits/common/drivers" -I"H:/SimplicityStudio/v3/developer/sdks/efm32/v2/kits/common/bsp" -I"H:/SimplicityStudio/v3/developer/sdks/efm32/v2/Device/SiliconLabs/EFM32G/Include" '-DEFM32G222F128=1' -o "$@" "$<"
